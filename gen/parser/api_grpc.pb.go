...
type ParserServiceClient interface {
	Parse(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*emptypb.Empty, error)
}
...
func (c *parserServiceClient) Parse(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	out := new(emptypb.Empty)
	err := c.cc.Invoke(ctx, "/ParserService/Parse", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type ParserServiceServer interface {
	Parse(context.Context, *emptypb.Empty) (*emptypb.Empty, error)
...
func (UnimplementedParserServiceServer) Parse(context.Context, *emptypb.Empty) (*emptypb.Empty, error) {
...
func _ParserService_Parse_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/ParserService/Parse",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ParserServiceServer).Parse(ctx, req.(*emptypb.Empty))
	}
