...
const (
	MessagesService_GetMessages_FullMethodName = "/MessagesService/GetMessages"
	MessagesService_Repost_FullMethodName      = "/MessagesService/Repost"
	MessagesService_Like_FullMethodName        = "/MessagesService/Like"
	MessagesService_Update_FullMethodName      = "/MessagesService/Update"
)
...
func (c *messagesServiceClient) GetMessages(ctx context.Context, in *GetMessagesRequest, opts ...grpc.CallOption) (*GetMessagesResponse, error) {
	...
	err := c.cc.Invoke(ctx, MessagesService_GetMessages_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *messagesServiceClient) Repost(ctx context.Context, in *RepostMessageRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	...
	err := c.cc.Invoke(ctx, MessagesService_Repost_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *messagesServiceClient) Like(ctx context.Context, in *LikeMessageRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	out := new(emptypb.Empty)
	err := c.cc.Invoke(ctx, MessagesService_Like_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *messagesServiceClient) Update(ctx context.Context, in *UpdateMessageRequest, opts ...grpc.CallOption) (*VkMessageExt, error) {
	...
	err := c.cc.Invoke(ctx, MessagesService_Update_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _MessagesService_Repost_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: MessagesService_Repost_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _MessagesService_Like_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: MessagesService_Like_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
